 ...
 */
class UserFakeRepository extends ServiceEntityRepository implements PasswordUpgraderInterface
{
    ...
    */
    ...
    /*
    public function findOneBySomeField($value): ?UserFake
    {
        return $this->createQueryBuilder('u')
            ->andWhere('u.exampleField = :val')
            ->setParameter('val', $value)
