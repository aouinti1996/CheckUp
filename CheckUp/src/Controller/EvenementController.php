...
// commentaires
     ...
     */
    public function eventDetails(EvenementRepository $repo, CommentaireRepository $commentRepo, UserRepository $userRepo, Request $request, $id)
    {
...
// Boutton Réserver
     ...
     */
    public function reserverEvenement(EvenementRepository $eventRepo, UserRepository $userRepo, $id): Response
    {
        $user = $userRepo->find(1);
